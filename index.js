...
// ANSWER: Num[3]--- so it just searches for one number. one function
...
// ANSWER: still O(n) because either way you have to push answers into new array.


// 15) Here are two functions that you came up with to count how many of each letter is in a 
//given string and 
...
// ANSWER: 1. has for each method. 2. O(1) because its just replacing an array
